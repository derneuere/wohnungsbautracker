...
import { latestYearTotals } from '../../lib/design-data'
import DesignSwitcher from '../../components/DesignSwitcher'

const MapView = lazy(() => import('../../components/Map'))

export const Route = createFileRoute('/designs/klassik')({
  head: () => ({
    meta: [{ title: 'Klassik — der bisherige Tracker' }],
  }),
  loader: async () => {
  ...
  component: KlassikPage,
})

function KlassikPage() {
  ...
  const { approved: totalApproved, completed: totalCompleted } = latestYearTotals(stats)
